...
from pore_pressure_during_injection_QinPackers.input_parameters import \
    delta_fi_list, delta_r_list, r_well, N_r_full, M_fi_full, X_matrix, Y_matrix, delta_r, delta_fi, delta_t, M_1
import numpy as np
import matplotlib.pyplot as plt
Pres_distrib_in_Time = np.load('../result_folder/calculation_1/Pres_distrib_in_Time_2.npy')
Func_matrix_remake_in_Time = np.load('../result_folder/calculation_1/Func_matrix_remake_in_Time.npy')
viscosity_in_Time = np.load('../result_folder/calculation_1/viscosity_in_Time.npy')
velocity_in_Time = np.load('../result_folder/calculation_1/velocity_in_Time.npy')
bound_coords_cart_in_Time = np.load('../result_folder/calculation_1/bound_coords_cart_in_Time.npy', allow_pickle=True)

Pres_distrib_in_Time_4 = np.load('../result_folder/calculation_1/Pres_distrib_in_Time_2.npy')

points_coords = {}
for key in points_r_fi_pair:
    points_coords[key] = (int(round(points_r_fi_pair[key][0]/delta_r)), int(round(points_r_fi_pair[key][1]/delta_fi)))
...
#PinPoint1_4 = Pres_distrib_in_Time_4[:, points_coords[1][0], points_coords[1][1]]
...
#axs[0, 0].plot(t_list, PinPoint1_4/10**6)

PinPoint2 = Pres_distrib_in_Time[:, points_coords[2][0], points_coords[2][1]]
#PinPoint2_4 = Pres_distrib_in_Time_4[:, points_coords[2][0], points_coords[2][1]]
...
#axs[0, 1].plot(t_list, PinPoint2_4/10**6)

PinPoint10 = Pres_distrib_in_Time[:, points_coords[10][0], points_coords[10][1]]
#PinPoint10_4 = Pres_distrib_in_Time_4[:, points_coords[10][0], points_coords[10][1]]
#PinCenter = Pres_distrib_in_Time[:, 1, M_1]
...
#axs[2, 1].plot(t_list, PinPoint10_4/10**6)
#axs[2, 1].plot(t_list, np.array(PinCenter)/10**6)

PinPoint6 = Pres_distrib_in_Time[:, points_coords[6][0], points_coords[6][1]]
PinPoint6_4 = Pres_distrib_in_Time_4[:, points_coords[6][0], points_coords[6][1]]
...
axs[1, 1].plot(t_list, PinPoint6_4/10**6)

PinPoint7 = Pres_distrib_in_Time[:, points_coords[7][0], points_coords[7][1]]
PinPoint7_4 = Pres_distrib_in_Time_4[:, points_coords[7][0], points_coords[7][1]]
...
axs[1, 0].plot(t_list, PinPoint7_4/10**6)

PinPoint9 = Pres_distrib_in_Time[:, points_coords[9][0], points_coords[9][1]]
PinPoint9_4 = Pres_distrib_in_Time_4[:, points_coords[9][0], points_coords[9][1]]
...
axs[2, 0].plot(t_list, PinPoint9_4/10**6)
...
axs[0].set_title(str((round(points_r_fi_pair[13][0], 2), round(points_r_fi_pair[13][1], 2))), y = 0.75, loc='left')
axs[0].set_xlabel("Time, s")
axs[0].set_ylabel("Pressure, MPa")
axs[0].plot(t_list_exp, P_filter_13)
axs[0].plot(t_list, PinPoint13/10**6)

PinPoint12 = Pres_distrib_in_Time[:, points_coords[12][0], points_coords[12][1]]
axs[1].set_title(str((round(points_r_fi_pair[12][0], 2), round(points_r_fi_pair[12][1], 2))), y = 0.75, loc='left')
axs[1].set_xlabel("Time, s")
axs[1].set_ylabel("Pressure, MPa")
axs[1].plot(t_list_exp, P_filter_12)
axs[1].plot(t_list, PinPoint12/10**6)
