...
for t in range(T_exp):
    ...
    Func_matrix_remake, Func_matrix_remake_in_cell_center = find_func_matrix_remake(coord_matrix_cart_cell, M_fi_full, N_r_full, bound_coords_cart_new, coord_matrix_cart)
