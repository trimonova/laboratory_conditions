...
for t in range(T_exp):
    ...
    # plt.show()
    #
    # plt.plot(Pres_distrib[:, 20])
    # plt.plot(Pres_distrib[:, 200])
    # plt.show()
    ...
    # surf = plt.contourf(X_matrix, Y_matrix, velocity, cmap=plt.get_cmap('jet'))
    # plt.title('velocity')
    # plt.colorbar(surf)
    # plt.show()
    #
    # plt.plot(velocity[:, 20])
    # plt.show()
    # plt.plot(velocity[:, 200])
    # plt.show()
...
plt.plot(viscosity_matrix[:, 20])

plt.plot(viscosity_matrix[:, 200])
plt.show()
