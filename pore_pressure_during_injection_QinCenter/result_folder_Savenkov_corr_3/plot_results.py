...
plt.plot(Pres_distrib_in_Time[0][:,10])
plt.plot(Pres_distrib_in_Time[10][:,10])
plt.plot(Pres_distrib_in_Time[20][:,10])
plt.plot(Pres_distrib_in_Time[30][:,10])
plt.plot(Pres_distrib_in_Time[-1][:,10])
plt.show()
...
plt.contour(X_matrix, Y_matrix, Func_matrix_remake_in_Time[20], levels=0)
...
plt.plot(velocity_in_Time[30][:,10])
# plt.plot(velocity_in_Time[10][:,10])
# plt.plot(velocity_in_Time[20][:,10])
...
plt.plot(viscosity_in_Time[10][:,10])
plt.plot(viscosity_in_Time[20][:,10])
plt.plot(viscosity_in_Time[30][:,10])
plt.plot(viscosity_in_Time[40][:,10])
plt.plot(viscosity_in_Time[50][:,10])
plt.plot(viscosity_in_Time[-1][:,10])
plt.title('viscosity_in_time')
plt.show()
