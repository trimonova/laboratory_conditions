...
#print(bound_coords_cart_in_Time[])
...
surf = plt.contourf(X_matrix, Y_matrix, Func_matrix_in_Time[0], cmap=plt.get_cmap('jet'))
plt.title('Func_matrix_0')
plt.colorbar(surf)
plt.show()

surf = plt.contourf(X_matrix, Y_matrix, Func_matrix_in_Time[5], cmap=plt.get_cmap('jet'))
plt.title('Func_matrix_5')
plt.colorbar(surf)
plt.show()

surf = plt.contourf(X_matrix, Y_matrix, Func_matrix_in_Time[10], cmap=plt.get_cmap('jet'))
plt.title('Func_matrix_10')
plt.colorbar(surf)
plt.show()

surf = plt.contourf(X_matrix, Y_matrix, Func_matrix_in_Time[19], cmap=plt.get_cmap('jet'))
plt.title('Func_matrix_19')
plt.colorbar(surf)
plt.show()

surf = plt.contourf(X_matrix, Y_matrix, Func_matrix_in_Time[-1], cmap=plt.get_cmap('jet'))
plt.title('Func_matrix_last')
plt.colorbar(surf)
plt.show()

surf = plt.contourf(X_matrix, Y_matrix, Func_matrix_remake_in_Time, cmap=plt.get_cmap('jet'))
plt.title('Func_matrix_remake_last')
plt.colorbar(surf)
plt.show()
